...
const { getRegister, getLogin, register,
  getProfile, updateProfile, deleteProfile, login, logOut, getForgotPw, updatePw, resetPw, updateResetPw } = require('../controllers/users');
...
router.put('/profile', isLoggin, upload.single('image'), isValidPassword, updateProfile)
// router.get('/forgot-pw', forgetPw)
router.get('/forgot-password', getForgotPw);
router.put('/forgot-password', updatePw)
